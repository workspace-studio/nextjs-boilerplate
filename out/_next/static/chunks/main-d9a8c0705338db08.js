    ...
    4266: function (e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.addBasePath = function (e, t) {
          return a.normalizePathTrailingSlash(n.addPathPrefix(e, '/nextjs-boilerplate'));
        });
      var n = r(5246),
        a = r(2387);
    ...
    2140: function (e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.hasBasePath = function (e) {
          return n.pathHasPrefix(e, '/nextjs-boilerplate');
        });
      var n = r(6325);
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
      ...
      class G extends _.default.Component {
        ...
        componentDidMount() {
          this.scrollToHash(),
            n.isSsr &&
              (a.isFallback ||
                (a.nextExport && (x.isDynamicRoute(n.pathname) || location.search || z)) ||
                (a.props && a.props.__N_SSG && (location.search || z))) &&
              n
                .replace(
                  n.pathname +
                    '?' +
                    String(j.assign(j.urlQueryToSearchParams(n.query), new URLSearchParams(location.search))),
                  o,
          ...
          i
            ...
            .then(r => {
              ...
              return Promise.resolve(
                (null == (i = e.props) ? void 0 : i.err) ? e.props : O.loadGetInitialProps(t, d)
              ).then(t => eo(y({}, e, { err: l, Component: s, styleSheets: u, props: t })));
            })
        );
      }
      function J(e) {
      ...
      function eo(e) {
        ...
        return (
          !(function (e, t) {
            ...
            } else (Q = P.default.hydrateRoot(e, r, { onRecoverableError: q.default })), (ee = !1);
          })(l, e =>
            _.default.createElement(ea, { callbacks: [e, h] }, _.default.createElement(_.default.StrictMode, null, m))
          ),
          p
        );
      }
    ...
    9577: function (e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.removeBasePath = function (e) {
          return (e = e.slice(19)).startsWith('/') || (e = '/'.concat(e)), e;
        }),
        r(2140),
        ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
          void 0 === t.default.__esModule &&
    ...
    6885: function (e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.createRouter = function () {
          for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
          return (
            (u.router = new o.default(...t)), u.readyCallbacks.forEach(e => e()), (u.readyCallbacks = []), u.router
          );
        }),
      ...
      function y(e) {
        ...
        if (
          ...
          ('beforeInteractive' === c || 'worker' === c) &&
            (g
              ? ((y[c] = (y[c] || []).concat([n({ id: t, src: r, onLoad: a, onReady: o, onError: f }, h)])), g(y))
              : v && v()
              ? p.add(t || r)
              : v && !v() && m(e)),
          _)
          ...
          return o.default.createElement(
            ...
            o.default.createElement(
              ...
              o.default.createElement(
                'title',
                null,
                e ? ''.concat(e, ': ').concat(r) : 'Application error: a client-side exception has occurred'
              )
            ),
            o.default.createElement(
              'div',
        ...
        (t.PathnameContextProviderAdapter = function (e) {
          ...
          let s = o.useRef(n.isAutoExport),
            u = o.useMemo(() => {
              let e;
              let t = s.current;
              if ((t && (s.current = !1), l.isDynamicRoute(r.pathname) && (r.isFallback || (t && !r.isReady))))
                return null;
              try {
                ...
                if (
                  ...
                  if (i.startsWith('/')) {
                    let t = g.parseRelativeUrl(i),
                      a = C.getNextPathnameInfo(t.pathname, { nextConfig: n, parseData: !0 }),
                    ...
                    return Promise.all([r.router.pageLoader.getPageList(), s.getClientBuildManifest()]).then(n => {
                      ...
                      if (
                        m.isDynamicRoute(s) ||
                        (!o && i.includes(f.normalizeLocalePath(w.removeBasePath(s), r.router.locales).pathname))
                      ) {
                        let r = C.getNextPathnameInfo(g.parseRelativeUrl(e).pathname, { parseData: !0 });
                      ...
                      let c = i.includes(u)
                        ? u
                        : F(f.normalizeLocalePath(w.removeBasePath(t.pathname), r.router.locales).pathname, i);
                  ...
                  if (c.startsWith('/')) {
                    let e = P.parsePath(c),
                      t = O.formatNextPathnameInfo(
                        a({}, C.getNextPathnameInfo(e.pathname, { nextConfig: n, parseData: !0 }), {
                          defaultLocale: r.router.defaultLocale,
                          buildId: '',
                        })
                      );
                      ...
                      if (!t.ok) {
                        ...
                        if (404 === t.status) {
                          ...
                          if (null == (n = z(e)) ? void 0 : n.notFound)
                            return { dataHref: r, json: { notFound: Z }, response: t, text: e, cacheKey: f };
                        }
                        let a = Error('Failed to load static props');
                        throw (i || s.markAssetError(a), a);
                      }
                      return { dataHref: r, json: l ? z(e) : null, response: t, text: e, cacheKey: f };
                    })
              )
      ...
      class $ {
        ...
        change(e, t, r, o, i) {
          ...
          return n(function* () {
            ...
            d._inFlightRoute &&
              d.clc &&
              (A || $.events.emit('routeChangeError', k(), d._inFlightRoute, U), d.clc(), (d.clc = null)),
            ...
            let K = l.removeTrailingSlash(G),
              ...
              ee = !o.shallow && (yield D({ asPath: r, locale: C.locale, router: d }));
            if (
              (p && ee && (j = !1),
              j &&
                '/_error' !== G &&
                ...
                (z.pathname = F(G, n)),
                z.pathname === G ||
                  ((G = z.pathname), (z.pathname = E.addBasePath(G)), ee || (t = _.formatWithValidation(z)))),
              !M.isLocalURL(r))
            )
              return X({ url: r, router: d }), !1;
              ...
              if (et && (!o || i.result))
                o
                  ? (r = _.formatWithValidation(
                      Object.assign({}, e, { pathname: i.result, query: L.omit(V, i.params) })
                    ))
                  : Object.assign(V, et);
              else {
                  ...
                  throw Error(
                    (o
                      ...
                      : 'The provided `as` value ('
                          .concat(n, ') is incompatible with the `href` value (')
                          .concat(K, '). ')) +
            ...
            try {
              ...
              if (
                (p || o.shallow || (yield d._bfl(r, 'resolvedAs' in l ? l.resolvedAs : void 0, C.locale)),
                'route' in l && ee)
              ) {
                ...
                if (
                  ...
                  let e =
                      !U.shallow && l.resolvedAs
                        ? l.resolvedAs
                        : E.addBasePath(b.addLocale(new URL(r, location.href).pathname, C.locale), !0),
                    t = e;
              ...
              if ('type' in l) {
                ...
                return X({ url: l.destination, router: d }), new Promise(() => {});
              }
              let s = l.Component;
              ...
              let f = o.shallow && C.route === (null != (ei = l.route) ? ei : K),
                ...
                P = a({}, C, { route: K, pathname: G, query: V, asPath: q, isFallback: !1 });
              if (p && er) {
                if (
                  ((l = yield d.getRouteInfo({
                    route: d.pathname,
        ...
        changeState(e, t, r) {
          ...
          ('pushState' !== e || h.getURL() !== r) &&
            ...
            window.history[e](
              { url: t, as: r, options: n, __N: !0, key: (this._key = 'pushState' !== e ? this._key : V()) },
              '',
              r
            ));
        }
        handleRouteInfoError(e, t, r, a, o, i) {
          ...
          return n(function* () {
            ...
            if (s.isAssetError(e) || i)
              throw ($.events.emit('routeChangeError', e, a, o), X({ url: a, router: l }), k());
            try {
              let n;
            ...
            try {
              ...
              let C = !c || 'initial' in c ? void 0 : c,
                ...
                R =
                  g && !y
                    ? null
                    : yield q({ fetchData: () => G(O), asPath: v ? '/404' : s, locale: d, router: P }).catch(e => {
                        if (g) return null;
                        throw e;
                      });
              if (
                ...
                t(),
                (null == R ? void 0 : null == (b = R.effect) ? void 0 : b.type) === 'redirect-internal' ||
                  (null == R ? void 0 : null == (S = R.effect) ? void 0 : S.type) === 'redirect-external')
              )
                return R.effect;
              ...
              if (j.isAPIRoute(e)) return X({ url: i, router: P }), new Promise(() => {});
              let M =
                  C ||
              ...
              return (
                ...
                P.isPreview ||
                  !M.__N_SSG ||
                  g ||
                  G(Object.assign({}, O, { isBackground: !0, persistCache: !1, inflightCache: P.sbc })).catch(() => {}),
        ...
        getInitialProps(e, t) {
          let { Component: r } = this.components['/_app'],
            n = this._wrapApp(r);
          return (t.AppTree = n), h.loadGetInitialProps(r, { AppTree: n, Component: e, router: this, ctx: t });
        }
        get route() {
        ...
        constructor(
          ...
          (this.sdc = {}),
            ...
            (this.onPopState = e => {
              ...
              if (!n) {
                ...
                this.changeState(
                  'replaceState',
                  _.formatWithValidation({ pathname: E.addBasePath(e), query: t }),
                  h.getURL()
                );
                return;
              }
              ...
              (!this.isSsr || o !== E.addBasePath(this.asPath) || s !== E.addBasePath(this.pathname)) &&
          ...
          if (
            ((this.basePath = '/nextjs-boilerplate'),
            (this.sub = c),
            (this.clc = null),
            (this._wrapApp = i),
            (this.isSsr = !0),
            ...
            let n = { locale: f },
              a = h.getURL();
            this._initialMatchesMiddlewarePromise = D({ router: this, locale: f, asPath: a }).then(
              o => (
                (n._shouldResolveHref = r !== e),
                this.changeState(
                  'replaceState',
                  o ? a : _.formatWithValidation({ pathname: E.addBasePath(e), query: t }),
                  a,
                  n
                ),
                o
    ...
    1410: function (e, t, r) {
      ...
      function o(e) {
        ...
        (t = t ? encodeURIComponent(t).replace(/%3A/i, ':') + '@' : ''),
          e.host
            ? (u = t + e.host)
            : r && ((u = t + (~r.indexOf(':') ? '['.concat(r, ']') : r)), e.port && (u += ':' + e.port)),
        ...
        (t.resolveHref = function (e, t, r) {
          ...
          if ((m[0] || '').match(/(\/\/|\\)/)) {
            console.error(
              "Invalid href '"
                ...
                .concat(e.pathname, "'. Repeated forward-slashes (//) or backslashes \\ are not valid in the href.")
            );
          ...
          try {
            ...
            if (u.isDynamicRoute(e.pathname) && e.searchParams && r) {
              ...
              i && (t = a.formatWithValidation({ pathname: i, hash: e.hash, query: o.omit(r, l) }));
            }
    ...
    9163: function (e, t) {
      ...
      class r {
        ...
        _smoosh() {
          ...
          if (
            (null !== this.slugName &&
              r.push(...this.children.get('[]')._smoosh(''.concat(e, '[').concat(this.slugName, ']/'))),
            !this.placeholder)
          ) {
            let t = '/' === e ? '/' : e.slice(0, -1);
          ...
          return (
            null !== this.restSlugName &&
              r.push(...this.children.get('[...]')._smoosh(''.concat(e, '[...').concat(this.restSlugName, ']/'))),
            null !== this.optionalRestSlugName &&
              r.push(
                ...this.children.get('[[...]]')._smoosh(''.concat(e, '[[...').concat(this.optionalRestSlugName, ']]/'))
              ),
            r
          );
        }
          ...
          if (a.startsWith('[') && a.endsWith(']')) {
            ...
            function o(e, r) {
              ...
              t.forEach(e => {
                if (e === r)
                  throw Error(
                    'You cannot have the same slug name "'.concat(r, '" repeat within a single dynamic path')
                  );
    ...
    8018: function (e) {
      ...
      ((t = {}).d = function (e, r) {
        ...
        (f = function (e, t) {
          ...
          return (
            s >= 0
              ...
              : r && (n = document.prerendering || d() > 0 ? 'prerender' : r.type.replace(/_/g, '-')),
            {
              name: e,
              value: void 0 === t ? -1 : t,
              rating: 'good',
            ...
            i = function (e) {
              e.forEach(function (e) {
                'first-contentful-paint' === e.name &&
                  (s && s.disconnect(),
                  e.startTime < a.firstHiddenTime && ((o.value = e.startTime - d()), o.entries.push(e), r(!0)));
              });
            },
            l =
              window.performance &&
        ...
        (I = function (e) {
          e.forEach(function (e) {
            e.interactionId &&
              ((L = Math.min(L, e.interactionId)), (A = (T = Math.max(T, e.interactionId)) ? (T - L) / 7 + 1 : 0));
          });
        }),
        (N = function () {
